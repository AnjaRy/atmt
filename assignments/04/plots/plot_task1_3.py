...
with open("assignments/04/bash/output_stats/output_norm_time_bleu.txt", 'r', encoding='utf-8') as infile:
    counter = 0
    rows = []
...
plt.savefig('assignments/04/plots/norm_bleu_bp_beam_size.png')

plt.figure() 
karl = sns.lineplot(data=df, x="beam_size", y="time", marker='o')
karl.set(xlabel='Beam Size', ylabel='Time in s')

plt.savefig('assignments/04/plots/norm_time_beam_size.png')
